...
import { ServiceProvider, FrameworkService } from "sunbird";
import { SignInCardComponent } from "./sign-in-card";
import { TranslateServiceStub, NavControllerMock, LoadingControllerMock, AppVersionMock, OAuthServiceMock,
         ContainerServiceMock,
         AuthServiceMock,
         TelemetryServiceMock,
         SharedPreferencesMock,  } from "../../../test-config/mocks-ionic";
