...
import { ToastController, NavParams, Platform, Events } from "ionic-angular";
...
describe("ContentRatingAlertComponent", () => {
  ...
  it("#translateLangConst should call translateMessage", fakeAsync(() => {
    let msg = TestBed.get(TranslateService);

    const spy = spyOn(msg, "get").and.callFake(arg => {
      return Observable.of("Cancel");
    });

    let translateLangConst = comp.translateLangConst("CANCEL");
