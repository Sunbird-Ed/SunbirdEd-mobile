...
export const mockGetFrameworkDetails = {
  getFrameworkAPIResponse: [
    {
      'identifier': 'ap_k-12_13_board',
      'code': 'board',
      'name': 'Board',
      'description': 'Board',
      'index': 1,
      ...
      'terms': [
        {
          'identifier': 'ap_k-12_13_board_stateandhrapradesh',
          ...
          'associations': [
            {
              'identifier': 'ap_k-12_13_medium_telugu',
              'code': 'telugu',
              'translations': null,
              'name': 'Telugu',
              'description': 'Telugu',
            ...
            {
              'identifier': 'ap_k-12_13_medium_english',
              'code': 'english',
              'translations': null,
              'name': 'English',
              'description': 'English',
      ...
      'terms': [
        {
          ...
          'associations': [
            {
              'identifier': 'ap_k-12_13_gradelevel_class7',
              'code': 'class7',
              'translations': null,
              'name': 'Class 7',
              'description': 'Class 7',
            ...
            {
              'identifier': 'ap_k-12_13_gradelevel_class9',
              'code': 'class9',
              'translations': null,
              'name': 'Class 9',
              'description': 'Class 9',
            ...
            {
              'identifier': 'ap_k-12_13_gradelevel_class8',
              'code': 'class8',
              'translations': null,
              'name': 'Class 8',
              'description': 'Class 8',
            ...
            {
              'identifier': 'ap_k-12_13_gradelevel_class10',
              'code': 'class10',
              'translations': null,
              'name': 'Class 10',
            ...
            {
              'identifier': 'ap_k-12_13_gradelevel_class6',
              'code': 'class6',
              'translations': null,
              'name': 'Class 6',
              'description': 'Class 6',
    ...
    {
      'identifier': 'ap_k-12_13_gradelevel',
      'code': 'gradeLevel',
      'name': 'Grade',
      'description': 'Grade',
      'index': 3,
      ...
      'terms': [
        {
          ...
          'associations': [
            {
              'identifier': 'ap_k-12_13_subject_mathematics',
              'code': 'mathematics',
              'translations': null,
              'name': 'Mathematics',
            ...
            {
              'identifier': 'ap_k-12_13_subject_science',
              'code': 'science',
              'translations': null,
              'name': 'Science',
              'description': 'Science',
        ...
        },
        {
          ...
          'associations': [
            ...
            {
              'identifier': 'ap_k-12_13_subject_biology',
              'code': 'biology',
              'translations': null,
              'name': 'Biology',
              'description': 'Biology',
            ...
            {
              'identifier': 'ap_k-12_13_subject_physicalscience',
...
export const mockSyllabusDetails = {
...
export const mockCurrentUserDetails = '{"age":-1,"avatar":"avatar","board":["stateandhrapradesh"],'
  + '"createdAt":"Sep 7, 2018 5:13:16 PM","day":-1,"gender":"","grade":["class10","class9"],'
  + '"gradeValueMap":{"class10":"Class 10","class9":"Class 9"},"handle":"Guest1","isGroupUser":false,'
  + '"language":"en","medium":["english"],"month":-1,"profileType":"TEACHER","source":"LOCAL",'
  + '"standard":-1,"subject":["biology","mathematics"],"syllabus":["ap_k-12_13"],"uid":"0722daf6-ba0b-4f27-8c7d-3868d431df17"}';
