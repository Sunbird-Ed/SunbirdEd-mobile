export const mockRes = {
  searchCriteriaResponse:
    { "age": 0, "contentTypes": ["TextBook"], "impliedFilters": [{ "name": "contentType", "values": [{ "apply": true, "count": 0, "name": "TextBook" }] }, { "name": "objectType", "values": [{ "apply": true, "count": 0, "name": "Content" }] }, { "name": "status", "values": [{ "apply": true, "count": 0, "name": "Live" }] }], "limit": 100, "mode": "soft", "offlineSearch": false, "offset": 0, "query": "", "searchType": "FILTER", "sortCriteria": [{ "sortAttribute": "me_averageRating", "sortOrder": "DESC" }] },
