...
import {
    ...
    ContentService, TelemetryService, CourseService, ProfileType, ShareUtil, PageAssembleService, PageId, Environment, InteractSubtype, InteractType, Profile, PageAssembleCriteria, PageAssembleFilter, QRScanner, PermissionService
} from "sunbird";
...
describe('ResourcesPage Component', () => {
    ...
    it("#ionViewDidEnter should should show highLighter on app start for fresh install", function (done) {
    ...
    it("#ionViewDidLoad should should show highLighter on app start for fresh install", function () {
        ...
        spyOn(telemetryGeneratorService, 'generateImpressionTelemetry').and.callThrough().and.callFake(function (success) {
        });
    ...
    it("#subscribeUtilityEvents should  update local contents when event is available", function () {
    ...
    it("#subscribeUtilityEvents should invoke getPopular Content when language is changed", function () {
        const events = TestBed.get(Events);
    ...
    it("#subscribeUtilityEvents should  invoke swipeDownToRefresh when profile object is changed", function () {
        const events = TestBed.get(Events);
        const pageService = TestBed.get(PageAssembleService);
    ...
    it("#subscribeUtilityEvents should show Upgrade popOver when upgrade event is fired", function () {
        const events = TestBed.get(Events);
        const appGlobalService = TestBed.get(AppGlobalService);
        spyOn(events, 'subscribe').and.callFake(function (arg, success) {
    ...
    it("#subscribeUtilityEvents should reset the filter when tab is changed", function () {
        const events = TestBed.get(Events);
    ...
    it('#navigateToViewMoreContentPage should navigate to ViewMoreList page', () => {
        const telemetryGeneratorService = TestBed.get(TelemetryGeneratorService);
        spyOn(telemetryGeneratorService, 'generateInteractTelemetry').and.callThrough().and.callFake(function ({ }, success) {
        });
    ...
    it('#getPopularContent should  apply all profile values in pageassemble criteria while filling up onboarding cards', () => {
        ...
        let profile: Profile = mockRes.sampleProfile;
    ...
    it('#showFilter should  apply all profile values in pageassemble criteria after applying filter', () => {
        ...
        spyOn(telemetryGeneratorService, 'generateInteractTelemetry').and.callFake(function (option, success, error) {
        });
    ...
    it('#scanQRCode should open the scanner', () => {
        ...
        spyOn(telemetryGeneratorService, 'generateInteractTelemetry').and.callFake(function ({ }, success, error) {
        });
    ...
    it('#search should navigate to SearchPage', () => {
        ...
        spyOn(telemetryGeneratorService, 'generateStartTelemetry').and.callFake(function ({ }, success, error) {
        });
